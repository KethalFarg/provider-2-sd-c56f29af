    ...
    return (
        <div className="basics-container">
            <div className="basics-header">
                <button className="header-icon" onClick={() => navigate('/goals/step-1')}><i className="fas fa-arrow-left"></i></button>
            ...
            <div className="basics-content">
                <div className="progress-section">
                    <div className="progress-header">
                        ...
                        <span className="progress-count">2/5</span>
                    </div>
                ...
                <h2 className="question-title">Do you believe your sales process could be improved?</h2>

                <div className="options-grid">
                    <button className="option-button">Yes</button>
                    <button className="option-button">No</button>
                    <button className="option-button">Not Sure</button>
                </div>
            </div>

            <div className="basics-footer">
                <div className="footer-buttons">
                    <button className="btn-prev" onClick={() => navigate('/goals/step-1')}>PREVIOUS</button>
                    <button className="btn-next" onClick={() => navigate('/goals/step-3')}>NEXT</button>
                </div>
            </div>
        </div>
    );
