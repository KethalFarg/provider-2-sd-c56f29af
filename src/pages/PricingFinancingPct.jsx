    ...
    return (
        <div className="basics-container">
            <div className="basics-header">
                <button className="header-icon" onClick={() => navigate('/pricing/step-2')}><i className="fas fa-arrow-left"></i></button>
            ...
            <div className="basics-content">
                ...
                <h2 className="question-title">What percentage of your patients require or prefer financing?</h2>
            ...
            <div className="basics-footer">
                <div className="footer-buttons">
                    <button className="btn-prev" onClick={() => navigate('/pricing/step-2')}>PREVIOUS</button>
                    <button className="btn-next" onClick={() => navigate('/pricing/step-4')}>NEXT</button>
                </div>
            </div>
        </div>
    );
...
export default PricingFinancingPct;
