...
const PatientFlowCover = () => {
    const navigate = useNavigate();

    return (
        <AnimatedBackground>
            <div className="basics-header" style={{ borderBottom: 'none', padding: 0, marginBottom: 0 }}>
                <button className="header-icon text-neutral-400" onClick={() => navigate('/practice/step-3')}><i className="fas fa-arrow-left"></i></button>
            ...
            <div className="cover-content">
                ...
                <div className="timeline">
                    ...
                    <div className="timeline-item active">
                        ...
                        <p className="timeline-subtitle">0/6 Completed</p>
                        <p style={{ marginTop: '0.5rem', fontSize: '1rem', color: '#d4d4d4', lineHeight: '1.5' }}>
                            Next, we'll look at how many patients you're starting each month and where those patients are coming from. This gives us a clear picture of your clinic's patient flow.
                        </p>
                    </div>
            ...
            <div className="basics-footer">
                <div className="footer-buttons">
                    <button className="btn-prev" onClick={() => navigate('/practice/step-3')} style={{ backgroundColor: 'black', color: 'white', borderColor: '#404040' }}>PREVIOUS</button>
                    <button className="btn-next" onClick={() => navigate('/patient-flow/step-1')} style={{ backgroundColor: 'white', color: 'black' }}>NEXT</button>
                </div>
            </div>
        </AnimatedBackground>
    );
...
export default PatientFlowCover;
