        ...
        */}
                <div className="relative w-full lg_w-35 bg-clinical-900 overflow-hidden">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: "url('https://imagedelivery.net/ye6TBwd9tSy8dGYL2VHjgg/3ba69018-2525-4118-26de-a4208540bf00/public')"
                        }}
                    />

                    {/* Desktop Background Image - New dedicated image */}
                    <div
                        className="absolute inset-0 bg-cover bg-center bg-no-repeat hidden lg_block"
                        style={{
                            backgroundImage: "url('https://imagedelivery.net/ye6TBwd9tSy8dGYL2VHjgg/b5b083a6-c05b-4bb4-ac22-4d046294d400/public')"
                        }}
                    />
                ...
                <div className="relative w-full lg_w-65 bg-white flex flex-col justify-center p-8 lg_p-24 overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-2xl">
                        ...
                        <Text theme="light" className="mt-6">
                            We're linking your responses to your practice profile and deploying your customized marketing strategy. Your local SEO and ad campaigns are being activated now.
                        </Text>
