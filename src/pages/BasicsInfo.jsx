    ...
    return (
        <div className="basics-container">
            <div className="basics-header">
                <button className="header-icon" onClick={() => navigate('/basics/cover')}><i className="fas fa-arrow-left"></i></button>
            ...
            <div className="basics-content">
                ...
                <div className="form-group">
                    <label className="form-label">City / State / Zip Code</label>
                    <input type="text" className="form-input" placeholder="" />
                </div>
            </div>
            ...
            <div className="basics-footer">
                <div className="footer-buttons">
                    <button className="btn-prev" onClick={() => navigate('/basics/cover')}>PREVIOUS</button>
                    <button className="btn-next" onClick={() => navigate('/basics/step-2')}>NEXT</button>
                </div>
            </div>
        </div>
    );
