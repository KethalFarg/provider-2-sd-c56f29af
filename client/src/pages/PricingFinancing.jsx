...
const PricingFinancing = () => {
    const navigate = useNavigate();

    return (
        <div className="basics-container">
            <div className="basics-header">
                <button className="header-icon" onClick={() => navigate('/pricing/step-1')}><i className="fas fa-arrow-left"></i></button>
            ...
            <div className="basics-content">
                ...
                <h2 className="question-title">Do you offer financing?</h2>
            ...
            <div className="basics-footer">
                <div className="footer-buttons">
                    <button className="btn-prev" onClick={() => navigate('/pricing/step-1')}>PREVIOUS</button>
                    <button className="btn-next" onClick={() => navigate('/pricing/step-3')}>NEXT</button>
                </div>
            </div>
        </div>
    );
